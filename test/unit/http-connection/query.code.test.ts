...
describe('QueryRequestCodec', () => {
    ...
    describe('.body', () => {
        ...
        it.each([
            ...
            ['Time without nanos', v(new Time(12, 50, 35, 0, 3600), { $type: 'Time', _value: '12:50:35+01:00' })],
            ['LocalTime', v(new LocalTime(12, 50, 35, 556000000), { $type: 'LocalTime', _value: '12:50:35.556000000' })],
            ['LocalTime without nanos', v(new LocalTime(12, 50, 35, 0), { $type: 'LocalTime', _value: '12:50:35' })],
...
describe('QueryResponseCodec', () => {
    ...
    describe('.meta', () => {
        ...
        ])('should handle plan (%o)', (queryPlan: any, expected: any, config?: Partial<types.InternalConfig>) => {
            const codec = subject({
                rawQueryResponse: {
                    ...DEFAULT_RAW_RESPONSE,
                    queryPlan
        ...
        it.each([
        ...
        ])('should handle plan arguments from type %s', (_: string, argument: any, expected: any, config?: Partial<types.InternalConfig>) => {
            const codec = subject({
                rawQueryResponse: {
                    ...DEFAULT_RAW_RESPONSE,
                    queryPlan: {
            ...
            //@ts-expect-error
            expect(codec.meta.plan.args).toEqual({
                'my arg': expected
            })

            //@ts-expect-error
            expect(codec.meta.plan.children[0].args).toEqual({
                'the other arg': expected
            })
        })
